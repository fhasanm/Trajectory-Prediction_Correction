...
if __name__ == '__main__':
    ...
    if args['resume_train']:
        net.load_state_dict(torch.load('trained_models/cslstm_m_0.tar'))
        if args['use_cuda']:
            net = net.cuda()
    ...
    trSet = ngsimDataset(r'C:\Users\Hailong\Projects\ngsim_preprocessed_oldgit\TrainSet.mat')
    valSet = ngsimDataset(r'C:\Users\Hailong\Projects\ngsim_preprocessed_oldgit\ValSet.mat')
    ...
    for epoch_num in range(pretrainEpochs+trainEpochs):
        ...
        for i, data in enumerate(trDataloader):
            ...
            # print(hist.device) #t, b, c  t=16
            # print(nbrs[1]) #t, v, c
            # print(mask.shape) #b, 3, 13, enc_size
            # print(fut.shape) #t, b, c  t=25
            # print(op_mask.shape) #t, b, c
        ...
        #torch.save(net.state_dict(), f'trained_models/cslstm_m_{epoch_num}.pt')
        #
            break
