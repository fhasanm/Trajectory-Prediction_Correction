...
class highwayNet(nn.Module):
    ...
    def __init__(self,args):
        ...
        self.lat = torch.nn.Linear(self.soc_embedding_size + self.dyn_embedding_size, self.num_lat_classes)
    ...
    ## Forward Pass
    def forward(self,hist,nbrs,masks=None,lat_enc=None,lon_enc=None):
        ...
        if self.use_maneuvers and type(lat_enc) is not type(None) and type(lon_enc) is not type(None):
