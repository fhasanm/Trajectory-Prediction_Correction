...
parser.add_argument('--interact_in_decoding', default=True, type=bool, help='Whether to consider spatial interactions among vehicles in decoding/predicting.')
...
parser.add_argument('--neighbor_distance', default=50, type=float, help="it's unit is the meters")
parser.add_argument('--max_num_object', default=22, type=int)
args = parser.parse_args()

# What does the data look like straight out of the mat files
# What does the dataloader dop to the data
# Why preprocess further
    ...
    for i_epoch in range(trained_epochs, args.num_epochs):
        ...
        for iteration, (ori_data, neighbor_matrices, _, _) in enumerate(train_loader):
            ...
            for now_history_frames in [16]:
                ...
                output_loc_GT = data[:, 2:4, now_history_frames:, :]
                if args.predict_velocity:
                    output_loc_GT = data[:, :2, now_history_frames:, :]
...
if __name__ == '__main__':
    ...
    dev_path = r'C:\Users\Hailong\Projects\ngsim_preprocessed_oldgit\ValSet.mat'
    test_path = r'C:\Users\Hailong\Projects\ngsim_preprocessed_oldgit\TestSet.mat'
    ...
    args.max_x_velocity = 14.85 #ft/0.2s
    args.max_x = 36.155
    args.max_y_velocity = 67.58
    args.max_y = 486.76
    resume_training = False
    args.resume_train_model_path = 'outputs/saved_models/STransformerRNN_1_4_1_gru_train_plus_val_0.0001_0.0_0.6_2_148072.pt'
    ...
    if args.do_test:
        #model_path = 'outputs/saved_models/best_models/STransformerRNN_1_4_1_gru_train_plus_val_0.0001_0.0_0.6_4_37018.pt'
        model_path = 'outputs/saved_models/STransformerRNN_1_4_1_gru_train_plus_val_0.0001_0.0_0.6_2_37018.pt'
